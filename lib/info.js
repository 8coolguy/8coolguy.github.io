export const pinnedProjects = [
    {
        ...
        image:"",
        description:"A neural network library designed to compare the serial, openmp, and cuda implmentation.",
        links:{
        }
    },
    {
...
export let about = "Hiii. My name is Arnav. Backend engineer curious about the world. I enjoy system programming, infastructure, and making software go fast. I am also working on a game called Conquest releasing soon.";
